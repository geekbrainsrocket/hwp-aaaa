...
while input("{Хотите добавить продукт? Введите да/нет: ") == 'да':
    ...
    features = {}
    while input("Хотите добавить описание продукта? Введите да/нет: ") == 'да':
        feature_key = input("Введите параметр продукта: ")
        feature_value = input("Введите значение параметра для продукта: ")
